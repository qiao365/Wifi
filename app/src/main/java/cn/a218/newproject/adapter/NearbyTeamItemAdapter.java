...
public class NearbyTeamItemAdapter extends BaseAdapter {
    ...
    public NearbyTeamItemAdapter(Context context, List<BitmapEntity> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = layoutInflater.inflate(R.layout.activity_nearbyteam_item, parent, false);
