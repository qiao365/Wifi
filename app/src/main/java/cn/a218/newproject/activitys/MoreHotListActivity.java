...
public class MoreHotListActivity extends AutoLayoutActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_more_hot_list);
        ...
        mAdapter.setOnRecyclerViewItemClickListener(new DanceItemAdapter.onRecyclerViewItemClickListener() {
            ...
            public void onRecyclerViewItemClick(View view, int postion) {
                Intent mIntent = new Intent(MoreHotListActivity.this, SortItemActivity.class);
