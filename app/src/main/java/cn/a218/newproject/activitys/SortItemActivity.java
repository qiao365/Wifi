...
public class SortItemActivity extends AutoLayoutActivity implements View.OnClickListener ,PullToRefreshBase.OnRefreshListener2<GridView>{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPullToRefreshGridView.setOnRefreshListener(SortItemActivity.this);
        ...
        tv_info.setText(getIntent().getExtras().getString("name", ""));
        mGridViewJingXuan.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                startActivity(new Intent(SortItemActivity.this, VideoPlayActivity.class));
            }
        });
    }
